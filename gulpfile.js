...
elixir((mix) => {
    ...
    mix.styles(['bootstrap.min.css', 'ol.css', 'style.css', 'offline-module.css'], 'public/css/general.css');
    ...
    mix.scripts(['md5.js', 'jquery.min.js', 'jquery-ui.min.js', 'jquery.ui.touch-punch.min.js', 'bootstrap.min.js', 'ol.js', 'map.js', 'NominatimParser.js', 'ReversePositionManager.js', 'GpsManager.js',
     'SearchModule.js', 'LocalHistory.js', 'Results.js', 'RouteFinder.js', 'Waypoint.js', 'RouteFinderSearchResults.js', 'Route.js', 'Leg.js', 'Step.js', 'OfflineManager.js', 'OfflineModule.js', 'app.js'], 'public/js/map.js');
