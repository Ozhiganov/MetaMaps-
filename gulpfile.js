...
elixir((mix) => {
    ...
    mix.styles(['bootstrap.min.css', 'ol.css', 'style.css'], 'public/css/general.css');
    ...
    mix.scripts(['jquery.min.js', 'bootstrap.min.js', 'ol.js', 'map.js', 'NominatimParser.js', 'ReversePositionManager.js', 'GpsManager.js',
     'SearchModule.js', 'LocalHistory.js', 'Results.js', 'RouteFinder.js', 'Waypoint.js', 'app.js'], 'public/js/map.js');
    ...
    mix.version(['public/css/staticPages.css', 'public/css/general.css', 'public/css/mapSearch.css', 'public/css/iframeSearch.css', 'public/css/routing.css', 'public/js/mapSearch.js', 'public/js/iframeSearch.js', 'public/js/routing.js', 'public/js/findRoute.js', 'public/js/map.js']);
});