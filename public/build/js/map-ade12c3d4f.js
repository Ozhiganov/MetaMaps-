...
NavigationModule.prototype.newPosition = function(position) {
            ...
            if (pointOnRoute !== null) {
                ...
                this.route.drivenRoute.coordinates.push(pos);
                var pointString = "";
                ...
                if(this.route.drivenRoute.coordinates.length >= 2){
                    ...
                    var bearing = this.getBearing(this.route.drivenRoute.coordinates[this.route.drivenRoute.coordinates.length-2], this.route.drivenRoute.coordinates[this.route.drivenRoute.coordinates.length-1]);
                ...
                $("#navigation #next-step .step-string").html("Neuberechnung...");
